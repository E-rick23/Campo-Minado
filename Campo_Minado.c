...
coorden ajuda(){
    ...
    //loops pra percorrer o campo minado
...
void menu(int * close){
    int opcao, end = 0;
    //Loop para manter o menu inicializado até uma das opções serem selecionadas.
    do{
        printf("\n");
        ...
        printf("4 - Sair\n");
        scanf("%d", &opcao);
        //Switch case que define as operações para cada valor que o usuário digitar.
        switch(opcao){
            case 1 :
            jogo();
            end = 1;
